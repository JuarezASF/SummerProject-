...
this time we'll first pass the input through a histogram equaliation. \n\n"
...
cv2.createTrackbar('areaTh',window_trackbar,200,2000,nothing)
...
while True:
    ...
    areaTh = max(1, cv2.getTrackbarPos('areaTh', window_trackbar))
    ...
    cnts = [c for c in cnts if cv2.contourArea(c) > areaTh]
